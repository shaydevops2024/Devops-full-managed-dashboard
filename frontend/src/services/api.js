// frontend/src/services/api.js - COMPLETE WITH TERRAFORM RESOURCES
...
export const deployAPI = {
  // Docker
  deployDocker: (data) => api.post('/deploy/docker', data),
  validateDockerfile: (content) => api.post('/deploy/validate-dockerfile', { content }),
  
  // Terraform
  deployTerraform: (data) => api.post('/deploy/terraform', data),
  terraformPlan: (content) => api.post('/deploy/terraform-plan', { content }),
  terraformApply: (content) => api.post('/deploy/terraform-apply', { content }),
  getTerraformResources: () => api.get('/deploy/terraform/resources'),
  destroyTerraformResource: (resourceAddress) => 
    api.post('/deploy/terraform/destroy-resource', { resourceAddress }),
  
  // Kubernetes
  deployKubernetes: (data) => api.post('/deploy/kubernetes', data),
  
  // Helm
  deployHelm: (data) => api.post('/deploy/helm', data),
  
  // ArgoCD
  deployArgoCD: (data) => api.post('/deploy/argocd', data),
  
  // Jenkins
  deployJenkins: (data) => api.post('/deploy/jenkins', data)
};
